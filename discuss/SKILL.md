---
name: discuss
description: "Interactive brainstorming/discussion mode — talk through an idea, problem, or decision like a teammate rather than a task-executor. Two modes — (1) direct back-and-forth with the user and (2) an independent multi-agent panel when the user asks for multiple perspectives."
---
